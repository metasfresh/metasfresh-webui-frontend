...
const FIELD_EDIT_WIDGET_TYPES = ['CostPrice'];
...
class TableItem extends Component {
    ...
    renderCells = (cols, cells) => {
        ...
        const { edited, updatedRow, listenOnKeys, forceKeysBind } = this.state;
            ...
            return (
                ...
                cols.map((item, index) => {
                    ...
                    const supportFieldEdit =
                        mainTable && this.isAllowedFieldEdit(item);
