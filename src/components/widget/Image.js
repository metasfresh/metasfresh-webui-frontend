...
class Image extends Component{
    ...
    uploadBlob(blob){
        ...
        .then(imageId =>
            this.updateImagePreview(imageId)
        )
        .then(imageId =>
            handlePatch(data.field, imageId)
        )
        .then(() =>
            new Promise(resolve => {
                this.setState(
