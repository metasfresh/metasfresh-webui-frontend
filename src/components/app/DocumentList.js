...
import { initLayout, getDataByIds } from '../../actions/GenericActions';
...
class DocumentList extends Component {
    ...
    componentWillReceiveProps(props) {
        ...
        if (defaultSort !== this.props.defaultSort && defaultSort !== sort) {
            this.setState({
                sort: defaultSort
            });
        }

        if (defaultPage !== this.props.defaultPage && defaultPage !== page) {
            this.setState({
                page: defaultPage || 1
            });
        }
    ...
    fetchLayoutAndData = isNewFilter => {
        const { windowType, type, setModalTitle, setNotFound } = this.props;
                ...
                this.mounted &&
                    this.setState(
                        ...
                        () => {
                            ...
                            setModalTitle &&
                                setModalTitle(response.data.caption);
                        }
                    );
            })
            .catch(() => {
    ...
    browseView = refresh => {
        ...
        this.getData(viewId, page, sort, refresh).catch(err => {
                ...
                this.setState(
                    ...
                    () => {
                        if (
                            ...
                            dispatch(selectTableItems(selection, windowType));
                        }
