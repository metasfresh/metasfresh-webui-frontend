...
import { quickActionsRequest } from '../../actions/ListActions';
...
class QuickActions extends Component {
    ...
    componentWillReceiveProps = nextProps => {
        ...
        if (
            nextProps.selectedWindowType &&
            nextProps.selectedWindowType !== nextProps.windowType
        ) {
            return;
        }
        ...
        if (
            (nextProps.selected &&
                JSON.stringify(nextProps.selected) !==
    ...
    render() {
        ...
        if (actions.length) {
            return (
                <div
                    className={
                        'js-not-unselect ' + (disabled ? 'disabled ' : '')
                    }
                >
